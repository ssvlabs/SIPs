...
- open-for-discussion: a step meant to indicate the SIP is in active discussion. Changes are still possible. A [github discussion board](https://github.com/bloxapp/SIPs/discussions) will be opened (a link set in the SIP page)
